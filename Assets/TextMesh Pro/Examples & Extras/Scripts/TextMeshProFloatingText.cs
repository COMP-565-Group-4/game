...
public class TextMeshProFloatingText : MonoBehaviour
{
    ...
    static WaitForSeconds[] k_WaitForSecondsRandom = new WaitForSeconds[] {
        new WaitForSeconds(0.05f), new WaitForSeconds(0.1f),  new WaitForSeconds(0.15f),
        new WaitForSeconds(0.2f),  new WaitForSeconds(0.25f), new WaitForSeconds(0.3f),
        new WaitForSeconds(0.35f), new WaitForSeconds(0.4f),  new WaitForSeconds(0.45f),
        new WaitForSeconds(0.5f),  new WaitForSeconds(0.55f), new WaitForSeconds(0.6f),
        new WaitForSeconds(0.65f), new WaitForSeconds(0.7f),  new WaitForSeconds(0.75f),
        new WaitForSeconds(0.8f),  new WaitForSeconds(0.85f), new WaitForSeconds(0.9f),
        new WaitForSeconds(0.95f), new WaitForSeconds(1.0f),
    };
    ...
    void Awake()
    {
        ...
        // Reference to Transform is lost when TMP component is added since it replaces it by a
        // RectTransform.
    ...
    void Start()
    {
        if (SpawnType == 0) {
            ...
            // m_textMeshPro.fontAsset = Resources.Load("Fonts & Materials/JOKERMAN SDF",
            // typeof(TextMeshProFont)) as TextMeshProFont; // User should only provide a string to
            // the resource. m_textMeshPro.fontSharedMaterial = Resources.Load("Fonts &
            // Materials/LiberationSans SDF", typeof(Material)) as Material;
    ...
    public IEnumerator DisplayTextMeshProFloatingText()
    {
        ...
        while (current_Count > 0) {
            ...
            m_textMeshPro.color =
                new Color32(start_color.r, start_color.g, start_color.b, (byte) alpha);
