    ...
    void Start()
    {
        ...
        for (int i = MinPointSize; i <= MaxPointSize; i += Steps) {
            if (SpawnType == 0) {
                ...
                // textMeshPro.font = Resources.Load("Fonts & Materials/LiberationSans SDF",
                // typeof(TextMeshProFont)) as TextMeshProFont; textMeshPro.anchor =
                ...
                go.transform.position = m_Transform.position + new Vector3(ratio * -orthoSize *
                0.975f, orthoSize * 0.975f - lineHeight, 1);
