...
public class Benchmark01_UGUI : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        if (BenchmarkType == 0) // TextMesh Pro Component
        {
            ...
            // m_textMeshPro.font = Resources.Load("Fonts & Materials/Anton SDF",
            // typeof(TextMeshProFont)) as TextMeshProFont; // Make sure the Anton SDF exists before
            // calling this... m_textMeshPro.fontSharedMaterial = Resources.Load("Fonts &
            // Materials/Anton SDF", typeof(Material)) as Material; // Same as above make sure this
            // material exists.
