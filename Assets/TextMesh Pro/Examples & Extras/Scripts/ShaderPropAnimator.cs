...
public class ShaderPropAnimator : MonoBehaviour
{
    ...
    IEnumerator AnimateProperties()
    {
        ...
        while (true) {
            // lightAngle = (m_Material.GetFloat(ShaderPropertyIDs.ID_LightAngle) + Time.deltaTime)
            // % 6.2831853f; m_Material.SetFloat(ShaderPropertyIDs.ID_LightAngle, lightAngle);
