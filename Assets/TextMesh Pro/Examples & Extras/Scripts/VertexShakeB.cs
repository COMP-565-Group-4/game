    ...
    IEnumerator AnimateVertexColors()
    {
        ...
        while (true) {
            ...
            for (int i = 0; i < lineCount; i++) {
                ...
                Vector3 centerOfLine = (textInfo.characterInfo[first].bottomLeft
                ...
                for (int j = first; j <= last; j++) {
                    ...
                    // Need to translate all 4 vertices of each quad to aligned with center of
                    // character. This is needed so the matrix TRS is applied at the origin for each
                    // character.
                    ...
                    matrix =
                        Matrix4x4.TRS(Vector3.one, Quaternion.identity, Vector3.one * randomScale);
                    ...
                    // Need to translate all 4 vertices of each quad to aligned with the center of
                    // the line. This is needed so the matrix TRS is applied from the center of the
                    // line.
                    ...
                    // Apply the matrix TRS to the individual characters relative to the center of
                    // the current line.
                    copyOfVertices[materialIndex][vertexIndex + 0] =
                        matrix.MultiplyPoint3x4(copyOfVertices[materialIndex][vertexIndex + 0]);
                    copyOfVertices[materialIndex][vertexIndex + 1] =
